...
public class NavDrawerMenuAdapter extends BaseAdapter {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (item.selected) {
            ...
            holder.text.setTextColor(context.getResources().getColor(R.color.primary_dark));
            holder.img.setColorFilter(context.getResources().getColor(R.color.primary_dark));
        } else {
            ...
            holder.img.setColorFilter(context.getResources().getColor(R.color.black));
        }
        return view;
    }
