...
public class AdicionarAulaDialog extends BaseDialog implements DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener {
    ...
    public static void show(FragmentManager fm, Turma turma, Callback callback) {
        ...
        Fragment prev = fm.findFragmentByTag("adicionar_aula");
        if (prev != null) {
            ft.remove(prev);
        }
        ft.addToBackStack(null);
        AdicionarAulaDialog frag = new AdicionarAulaDialog();
        frag.callback = callback;
        Bundle args = new Bundle();
        args.putSerializable(ListTurma.KEY, turma);
        frag.setArguments(args);
        frag.show(ft, "adicionar_aula");
    }
    ...
    public void setData() {
        ...
        DatePickerDialog dpd = DatePickerDialog.newInstance(
                AdicionarAulaDialog.this,
                now.get(Calendar.YEAR),
                now.get(Calendar.MONTH),
                now.get(Calendar.DAY_OF_MONTH)
        );
        dpd.dismissOnPause(true);
        dpd.setOnCancelListener(AdicionarAulaDialog.this);
    ...
    public void setHora() {
        ...
        tpd.setOnCancelListener(AdicionarAulaDialog.this);
