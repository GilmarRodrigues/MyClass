 ...
 */
public class AdicionarHorarioDialog extends BaseDialog implements TimePickerDialog.OnTimeSetListener {
    ...
    public static void show(FragmentManager fm, Callback callback) {
        ...
        Fragment prev = fm.findFragmentByTag("adicionar_horario");
        if (prev != null) {
            ft.remove(prev);
        }
        ft.addToBackStack(null);
        AdicionarHorarioDialog frag = new AdicionarHorarioDialog();
        frag.callback = callback;
        Bundle args = new Bundle();
        frag.setArguments(args);
        frag.show(ft, "adicionar_horario");
    }
    ...
    public void setHora() {
        ...
        TimePickerDialog tpd = TimePickerDialog.newInstance(
                AdicionarHorarioDialog.this,
                now.get(Calendar.HOUR_OF_DAY),
                now.get(Calendar.MINUTE),
                true
        );
        tpd.dismissOnPause(true);
        tpd.setOnCancelListener(AdicionarHorarioDialog.this);
